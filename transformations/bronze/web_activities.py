...
@dp.table(
    name=f"{CATALOG}.{BRONZE_SCHEMA}.web_activities",
    comment="Raw web_activities ingestion"
    
)
def bronze_web_activities():
    path = config.get_path(RAW_SCHEMA,"web_activities")
